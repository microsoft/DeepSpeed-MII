...
def get_aks_target(aks_name, aml_workspace,  aks_provision_config=None):
    ...
    try:
        ...
        if aks_provision_config is None:
            mii.utils.logger.warn(f"aks_provision_config is {aks_provision_config}, attempting to use a default settings ")
        ...
        aks_target = ComputeTarget.create(
            workspace=aml_workspace, name=aks_name, provisioning_configuration=prov_config
        )
