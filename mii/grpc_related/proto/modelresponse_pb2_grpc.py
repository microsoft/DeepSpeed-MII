...
class ModelResponseStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Load = channel.unary_unary(
                '/modelresponse.ModelResponse/Load',
                request_serializer=modelresponse__pb2.LoadRequest.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                )
        self.Offload = channel.unary_unary(
                '/modelresponse.ModelResponse/Offload',
                request_serializer=modelresponse__pb2.LoadRequest.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                )
...
def add_ModelResponseServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Load': grpc.unary_unary_rpc_method_handler(
                    servicer.Load,
                    request_deserializer=modelresponse__pb2.LoadRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
...
class ModelResponse(object):
    ...
    def Load(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/modelresponse.ModelResponse/Load',
            modelresponse__pb2.LoadRequest.SerializeToString,
            google_dot_protobuf_dot_empty__pb2.Empty.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Offload(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/modelresponse.ModelResponse/Offload',
            modelresponse__pb2.LoadRequest.SerializeToString,
            google_dot_protobuf_dot_empty__pb2.Empty.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
