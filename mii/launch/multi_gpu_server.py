...
def main():
    ...
    parser.add_argument("-o", "--ds-optimize", action='store_true', help="Enable DeepSpeed" )
    parser.add_argument(
        "-p",
        "--port",
        type=int,
    ...
    inference_pipeline = load_models(args.task_name, args.model, args.model_path, args.ds_optimize)
