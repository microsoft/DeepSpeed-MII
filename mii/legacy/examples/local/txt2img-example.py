...
if not args.query:
    mii_configs = {
        ...
        "dtype": "fp16",
        "hf_auth_token": os.environ.get("HF_AUTH_TOKEN", "hf_xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"),
        "port_number": 50050
    }
    ...
    result = generator.query({'query': ["a panda in space with a rainbow", "a soda can on top a snowy mountain"]})
