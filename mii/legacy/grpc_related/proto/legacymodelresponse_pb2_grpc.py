...
def add_ModelResponseServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler('legacymodelresponse.ModelResponse', rpc_method_handlers)
...
class ModelResponse(object):
    ...
    def GeneratorReply(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/legacymodelresponse.ModelResponse/GeneratorReply',
                                             ...
                                             legacymodelresponse__pb2.MultiStringReply.FromString, options,
                                             channel_credentials, insecure, call_credentials, compression,
                                             wait_for_ready, timeout, metadata)
    ...
    def ClassificationReply(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/legacymodelresponse.ModelResponse/ClassificationReply',
                                             ...
                                             legacymodelresponse__pb2.SingleStringReply.FromString, options,
                                             channel_credentials, insecure, call_credentials, compression,
                                             wait_for_ready, timeout, metadata)
    ...
    def ConversationalReply(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/legacymodelresponse.ModelResponse/ConversationalReply',
                                             ...
                                             legacymodelresponse__pb2.ConversationReply.FromString, options,
                                             channel_credentials, insecure, call_credentials, compression,
                                             wait_for_ready, timeout, metadata)
    ...
    def Txt2ImgReply(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/legacymodelresponse.ModelResponse/Txt2ImgReply',
                                             legacymodelresponse__pb2.MultiStringRequest.SerializeToString,
                                             legacymodelresponse__pb2.ImageReply.FromString, options,
                                             channel_credentials, insecure, call_credentials, compression,
                                             wait_for_ready, timeout, metadata)
