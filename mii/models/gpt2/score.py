...
def init():
    ...
    #TODO set the parallelism degree somehow. On the AKS server we can set the gpu core
    ...
    global generator
    generator = mii.MIIGenerationServerClient('gpt2', model_path, use_grpc_server=use_grpc_server, initialize_grpc_client=initialize_grpc_client)
